...
//!
//! The data is fetched at runtime over HTTP from the website
//! (`https://seanyang.me/data/*.json` by default), which is the single source
//! of truth shared with the web frontend. A bundled snapshot in
